...
from quasim import QuaSim as quasim, Circuit
...
def create_random_circuits(
    ...
    for _ in range(gate_count):
        ...
        if gate_type == "H":
            ...
            quasim_circuit.apply(X(target_qubit))

        elif gate_type == "Y":
            target_qubit = randint(0, qubit_num - 1)
            qiskit_circuit.y(target_qubit)
            quasim_circuit.apply(Y(target_qubit))

        elif gate_type == "Z":
            target_qubit = randint(0, qubit_num - 1)
            qiskit_circuit.z(target_qubit)
            quasim_circuit.apply(Z(target_qubit))
            ...
            quasim_circuit.apply(CS(control_qubit, target_qubit))

        elif gate_type == "CH":
            target_qubit, control_qubit = sample(range(0, qubit_num), 2)
            qiskit_circuit.ch(control_qubit, target_qubit)
            quasim_circuit.apply(CH(control_qubit, target_qubit))
            ...
            quasim_circuit.apply(CY(control_qubit, target_qubit))

        elif gate_type == "CZ":
            target_qubit, control_qubit = sample(range(0, qubit_num), 2)
            qiskit_circuit.cz(control_qubit, target_qubit)
            quasim_circuit.apply(CZ(control_qubit, target_qubit))
            ...
            quasim_circuit.apply(RX(target_qubit, theta))
            ...
            quasim_circuit.apply(RY(target_qubit, theta))
            ...
            quasim_circuit.apply(RZ(target_qubit, theta))
            ...
            quasim_circuit.apply(CRX(control_qubit, target_qubit, theta))
            ...
            quasim_circuit.apply(CRY(control_qubit, target_qubit, theta))
            ...
            quasim_circuit.apply(CPhase(control_qubit, target_qubit, theta))
            ...
            quasim_circuit.apply(CRZ(control_qubit, target_qubit, theta))
            ...
            quasim_circuit.apply(CCX(control_qubit1, control_qubit2, target_qubit))
            ...
            quasim_circuit.apply(CCZ(control_qubit1, control_qubit2, target_qubit))
            ...
            quasim_circuit.apply(Phase(target_qubit, theta))

        elif gate_type == "SWAP":
            qubit1, qubit2 = sample(range(0, qubit_num), 2)

            qiskit_circuit.swap(qubit1=qubit1, qubit2=qubit2)
            quasim_circuit.apply(Swap(qubit1, qubit2))

        else:
            raise NotImplementedError()

    return (qiskit_circuit, quasim_circuit)
...
def evaluate_quasim_circuits(
    circuits: List[Circuit], simulator: quasim
) -> List[List[float]]:
